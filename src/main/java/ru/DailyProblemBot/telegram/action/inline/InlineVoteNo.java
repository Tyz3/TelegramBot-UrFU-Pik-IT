...
public class InlineVoteNo extends InlineAction {

    public InlineVoteNo(String actionName) {
        super(actionName);
    }
    ...
    public void handle(String chatId, CallbackQuery callbackQuery, UserProperties properties) {
        ...
        // Создать голос
        Vote vote = new Vote(properties.getUser(), task, false);
        ...
        // Отправить alert пользователю аля ваш голос засчитан как Против
        Messages.tasks_inlineAnswer_vote
                .replace("{approved}", "Против")
